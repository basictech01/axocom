    ...
    <>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white leading-tight group-hover:text-primary-accent transition-colors">{title}</h3>
...
const Careers: React.FC = () => {
  return (
    <div className="min-h-screen w-full bg-background-dark font-space">
      ...
      {/* Main Content */}
      <div className="pt-28 pb-20 px-4 md:px-10 lg:px-20">
        <div className="max-w-[1400px] mx-auto flex flex-col gap-16">
          
          {/* Hero Header with Border and Background */}
          <div className="relative rounded-3xl overflow-hidden min-h-[300px] md:min-h-[350px] flex flex-col justify-center items-center text-center p-6 md:p-8 bg-cover bg-center border border-white/10"
               style={{
          ...
          >
            <span className="text-white font-mono text-xs md:text-sm tracking-[0.3em] uppercase bg-white/10 px-3 py-1 rounded-full mb-4 border border-white/20">Careers</span>
          ...
          {/* Roles Grid */}
          <div>
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 sm:mb-8 px-2 border-l-4 border-primary pl-4">
              Find Your Path
            </h3>
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-br from-primary/10 to-primary-accent/10 rounded-3xl p-8 md:p-12 text-center border border-white/10">
            ...
            <a 
              ...
              className="inline-block px-10 py-4 bg-primary hover:bg-blue-600 text-white font-bold rounded-xl text-lg transition-all transform hover:scale-105 shadow-lg shadow-primary/30"
            >
              Apply Now
            </a>
          </div>
      ...
      {/* Footer */}
      <footer className="w-full py-10 px-6 border-t border-white/5 bg-background-dark text-gray-400">
